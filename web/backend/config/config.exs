...
config :backend, BackendWeb.Endpoint,
  ...
  live_view: [signing_salt: "qrc/QYTT"]
...
config :esbuild,
  ...
  backend: [
    args:
      ~w(js/app.js js/remote_executor.js --bundle --format=esm --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --alias:@=.),
