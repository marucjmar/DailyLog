defmodule BackendWeb.Router do
  ...
  scope "/api/json" do
    ...
    forward "/", BackendWeb.AshJsonApiRouter
  end
  ...
  scope "/", BackendWeb do
    ...
    confirm_route Backend.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [BackendWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Backend.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [BackendWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end
